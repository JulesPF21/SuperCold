...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_MoveAction = inputs.actions.FindAction("Player/Move");
            m_LookAction = inputs.actions.FindAction("Player/Look");
            m_JumpAction = inputs.actions.FindAction("Player/Jump");
            m_FireAction = inputs.actions.FindAction("Player/Fire");
            m_AimAction = inputs.actions.FindAction("Player/Aim");
            m_SprintAction = inputs.actions.FindAction("Player/Sprint");
            m_CrouchAction = inputs.actions.FindAction("Player/Crouch");
            m_ReloadAction = inputs.actions.FindAction("Player/Reload");
            m_NextWeaponAction = inputs.actions.FindAction("Player/NextWeapon");
